...
public abstract class Habitat {
  ...
  protected Habitat(Random random, Logger logger, HabitatType habitatType, SavannahConfiguration habitatConfiguration, Matrix matrix, PopulatorRoutine populatorRoutine) {
    this.random = random;
    this.logger = logger;
