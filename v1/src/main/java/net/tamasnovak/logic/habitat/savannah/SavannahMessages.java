...
final class SavannahMessages {
  ...
  static final String ANIMAL_STATS_INTRO = "The following number of animal types were placed into the simulation:";
  static final String ANIMAL_STATS_DETAIL = "%s %s live(s) in the simulation.";
